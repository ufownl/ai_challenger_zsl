...
using training_net = loss_multiattr<dlib::sig<base_network<81>::training_type>>;
...
int main(int argc, char* argv[]) {
  ...
  std::ifstream images_in("ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321/zsl_b_vehicles_train_annotations_attributes_20180321.txt");
  if (!images_in) {
    std::cerr << "Could not load the dataset." << std::endl;
    return 1;
  }
  auto images = load_image_attributes(images_in, 81);
  std::cout << "images in dataset: " << images.size() << std::endl;

  constexpr auto initial_learning_rate = 0.1;
  pre_trained_net pnet;
  dlib::deserialize("models/b_vehicles_pre_train.resnet34") >> pnet;
  ...
  trainer.set_synchronization_file("states/b_vehicles_train.state", std::chrono::minutes{10});
  ...
  auto load_data = [&data, &images](time_t seed) {
    ...
    while(data.is_enabled()) {
      ...
      dlib::load_image(img, "ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321" + inf.first);
  ...
  dlib::serialize("models/b_vehicles_train.resnet34") << net;

  std::cout << "Validating..." << std::endl;
  validator<81> v{net};
  v.load_dataset("ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321/zsl_b_vehicles_train_annotations_label_list_20180321.txt",
                 "ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321/zsl_b_vehicles_train_annotations_labels_20180321.txt",
                 "ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321/zsl_b_vehicles_train_annotations_attributes_per_class_20180321.txt");
  v.run("ai_challenger_zsl2018_train_test_b_20180321/zsl_b_vehicles_train_20180321");
