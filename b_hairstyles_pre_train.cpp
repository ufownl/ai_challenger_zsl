...
using training_net = dlib::loss_multiclass_log<base_network<24>::training_type>;
...
int main(int argc, char* argv[]) {
  ...
  std::ifstream images_in("ai_challenger_zsl2018_train_test_b_20180321/zsl_b_hairstyles_train_20180321/zsl_b_hairstyles_train_annotations_labels_20180321.txt");
  ...
  trainer.set_synchronization_file("states/b_hairstyles_pre_train.state", std::chrono::minutes{10});
