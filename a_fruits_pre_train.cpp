...
int main(int argc, char* argv[]) {
  ...
  std::ifstream images_in("ai_challenger_zsl2018_train_test_a_20180321/zsl_a_fruits_train_20180321/zsl_a_fruits_train_annotations_labels_20180321.txt");
  ...
  trainer.set_synchronization_file("states/a_fruits_pre_train.state", std::chrono::minutes{10});
  ...
  dlib::serialize("models/a_fruits_pre_train.resnet34") << net;
  return 0;
}
