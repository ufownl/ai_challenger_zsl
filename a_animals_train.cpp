...
int main(int argc, char* argv[]) {
  ...
  dlib::deserialize("models/a_animals_pre_train.resnet34") >> pnet;
  ...
  trainer.set_synchronization_file("states/a_animals_train.state", std::chrono::minutes{10});
  ...
  dlib::serialize("models/a_animals_train.resnet34") << net;
